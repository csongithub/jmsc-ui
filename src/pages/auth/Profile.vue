      ...
      <div class="col-4 password">
        <q-card class="my-card">
          <q-form @submit="updatePassword" @reset="reset" class="">
            <q-card-section>
              <div class="text-primary text-center text-subtitle1 q-mb-lg">
                Update Password
              </div>
              ...
              <q-input
                ...
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'Enter Current password',
                ]"
              />
              <q-input
                dense
              ...
              <q-input
                ...
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'Re-enter New password',
                ]"
              />
            </q-card-section>
            <q-card-actions>
...
export default {
  ...
  methods: {
    updatePassword() {
      this.updatePasswordRequest.logonId = this.admin
        ? this.client.logonId
        : this.user.logonId;
      this.updatePasswordRequest.admin = this.admin;
      if (
        this.updatePasswordRequest.newPassword !==
        this.updatePasswordRequest.reNewPassword
      ) {
