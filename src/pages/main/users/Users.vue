    ...
    >
      <q-card style="width: 700px; max-width: 80vw">
        ...
        <q-tabs
          ...
          no-caps
        >
          <q-tab name="user" label="User"> </q-tab>
        ...
        >
            ...
            <q-card-section>
              <q-form @submit="addUser" @reset="reset" class="q-gutter-md">
                <q-input
                  ...
                  lazy-rules
                  :rules="[
                    (val) => (val && val.length > 0) || 'Enter Site name',
                  ]"
                />
                <q-input
                  dense
                  ...
                  lazy-rules
                  :rules="[
                    (val) => (val && val.length > 0) || 'Enter Display Name',
                  ]"
                />
                <q-input
                  dense
                ...
                <q-select
                  ...
                  label="Status"
                  lazy-rules
                  :rules="[(val) => (val && val.length > 0) || 'Enter status']"
                />
          ...
          <q-tab-panel name="permissions">
            <q-form
              @submit="updateUserPermission"
              class="q-gutter-md"
              v-if="user.id"
            >
              <div class="row q-ma-md">
                <div class="col">Can Login</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
              ...
              <q-separator />
              <div class="row q-ma-md">
                <div class="col">Create Payments</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
              ...
              <div class="row q-ma-md">
                <div class="col">Approve Payments</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
              ...
              <q-separator />
              <div class="row q-ma-md">
                <div class="col">Add/Update Party</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
                    v-model="permissions.addParty"
                    class="my-custom-toggle"
                    no-caps
                    rounded
                    unelevated
              ...
              <div class="row q-ma-md">
                <div class="col">Add/Update Party Bank Account</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
                    v-model="permissions.updatePartyBankAccount"
                    class="my-custom-toggle"
                    no-caps
                    rounded
                    unelevated
              ...
              <div class="row q-ma-md">
                <div class="col">Update Party Bank Account Status</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
                    v-model="permissions.updatePartyBankAccountStatus"
                    class="my-custom-toggle"
                    no-caps
                    rounded
                    unelevated
              ...
              <div class="row q-ma-md">
                <div class="col">Delete Party</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
                    v-model="permissions.deleteParty"
                    class="my-custom-toggle"
                    no-caps
                    rounded
                    unelevated
              ...
              <q-separator />
              <div class="row q-ma-md">
                <div class="col">Add Machine</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
                    v-model="permissions.addMachine"
                    class="my-custom-toggle"
                    no-caps
                    rounded
                    unelevated
              ...
              <div class="row q-ma-md">
                <div class="col">Update Machine</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
                    v-model="permissions.updateMachine"
                    class="my-custom-toggle"
                    no-caps
                    rounded
                    unelevated
              ...
              <div class="row q-ma-md">
                <div class="col">Delete Machine</div>
                <div class="col">
                  <q-btn-toggle
                    size="sm"
                    v-model="permissions.deleteMachine"
                    class="my-custom-toggle"
                    no-caps
                    rounded
                    unelevated
            ...
            <div v-else class="text-center">Please add user first.</div>
          </q-tab-panel>
        </q-tab-panels>
      </q-card>
    </q-dialog>
  ...
  methods: {
    ...
    updateUserPermission() {
      ...
      UserPermissions.createOrUpdate(userPermissionsDTO)
        .then((response) => {
          if (response) this.success("User Permissions Updated Successfully");
        })
        .catch((err) => {
          this.fail(this.getErrorMessage(err));
        });
    ...
    deleteUser(row) {
      this.$q
        ...
        .onOk(() => {
          UserService.deleteUser(this.client_id, row.id)
            .then((response) => {
              if (response === 0) {
                this.getAllUsers();
