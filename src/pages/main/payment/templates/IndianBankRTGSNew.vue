      ...
      <table style="width:100%;">
       <tr>
        ...
        <tr>
          ...
          <td ><b>{{payment.from_acc_name}}</b></td>
          <td>{{'Name'}}</td>
          <td><b>{{payment.to_acc_name}}</b></td>
        </tr>
        <tr>
          <td>{{'Mobile No'}}</td>
        ...
        <tr>
          ...
          <td>{{''}}</td>
          <td>{{'Account No'}}</td>
          <td><b>{{payment.to_acc_no}}</b></td>
        </tr>
        <tr>
          <td>{{'Total Amount'}}</td>
          <td>{{''}}</td>
          <td>{{'Amount In Words'}}</td>
          <td><b>{{payment.amount_in_words}}</b></td>
        </tr>
        <tr>
