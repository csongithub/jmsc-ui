...
<template>
  <div>
          ...
          <q-td colspan="100%">
            <q-card>
              <q-card-section v-if="isNotNullOrUndefined(props.row)">
                <div
                  class="row row_attr"
                  v-for="(attr, index) in props.row.attributes"
                  :key="index"
                >
                ...
                <q-btn
                  @click="adminApproval(props.row, 'view')"
                  class="text-capitalize q-mt-lg q-mr-sm"
                  size="sm"
                  color="primary"
                  label="View As Admin"
                  dense
                ...
                />
                <q-btn
                  @click="adminApproval(props.row, 'update')"
                  class="text-capitalize q-mt-lg q-mr-sm"
                  size="sm"
                  color="primary"
                  label="Update"
                ...
                />
                <q-btn
                  @click="adminApproval(props.row, 'remove')"
    ...
    <q-dialog v-model="open" persistent @hide="onHide" ref="newAccountRef">
      <q-card style="width: 900px; max-width: 80vw">
        ...
        <q-card-section>
          <q-form @submit="addAccount" @reset="reset" class="q-gutter-md">
            ...
            <q-separator />
            <div class="row text-bold text-u">Account Attributes</div>
            <div>
      ...
      <q-card style="width: 900px; max-width: 80vw">
        ...
        <q-card-section>
          <q-card-section>
            ...
            <div class="row">
              <div class="col text-url text-weight-light">
                ...
                <q-btn
                  ...
                  class=""
                  flat
                  @click="copyURL(fetched_account.url)"
                  style="cursor: pointer"
                  :icon="icons.copy"
                >
                  <q-tooltip>Copy this url</q-tooltip>
            ...
            <div class="row q-mt-md text">Account Attributes</div>
            <!-- <div class="row">
            ...
            <div
              class="row row_attr"
              v-for="(attr, index) in fetched_account.attributes"
              :key="index"
            >
...
export default {
  ...
  methods: {
    copyURL(url) {
      copyToClipboard(url)
        .then(() => {
          this.$q.notify({ type: "positive", message: "Address Copied !" });
        })
        .catch(() => {
