    ...
    <div>
      ...
      >
        <template v-slot:top-right>
          <q-btn class="q-mr-sm text-capitalize" 
            flat
            round
            color="primary"
          ...
          <q-card-section>
            <q-form @submit="createBid" @reset="reset" class="q-gutter-md">
              ...
              <div class="row">
                ...
                <div>
                  <q-input dense outlined placeholder="dd-mm-yyyy" v-model="bid.nitDate" :rules="['DD-MM-YYYY']"  label="NIT Date">
                  <template v-slot:append>
              ...
              <div class="row">
                <div class="col q-mr-md">
                  <q-input dense outlined placeholder="dd-mm-yyyy" v-model="bid.bidStartDate" :rules="['DD-MM-YYYY']"  label="Bid Submission Start Date">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
                ...
                <div class="col q-mr-md">
                  <q-input dense outlined placeholder="dd-mm-yyyy" v-model="bid.bidEndDate" :rules="['DD-MM-YYYY']"  label="Bid Submission End Date">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
                ...
                <div class="col">
                  <q-input dense outlined placeholder="dd-mm-yyyy" v-model="bid.bidOpeningDate" :rules="['DD-MM-YYYY']"  label="Bid Opening Date">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
              ...
              <div class="row">
                ...
                <div class="col q-mr-md">
                  <q-input dense outlined placeholder="dd-mm-yyyy" v-model="bid.bidSubmittedDate" :rules="['DD-MM-YYYY']"  label="Bid Submitted Date">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
...
export default {
  ...
  methods: {
    ...
    getAllRejectedBids() {
      this.loading = true;
      BidService.getAllRejectedBids(this.clientId)
        .then(response => {
    ...
    getBidStatusOptions() {
      let req= {
        enumName: 'EBidStatus',
        skipList: ['CREATED', 'TECHNICAL_ACCEPTED', 'FINANCIAL_ACCEPTED', 'AWARDED', ]
      }
