        ...
        <template v-slot:body-cell-actions="props">
          <q-td :props="props">
            <div >
               ...
               <q-icon class="q-ma-none q-pa-none pointer" color="primary" :name="icons.edit" @click="editMachine(props.row)"/>
            </div>
          </q-td>
        </template>
        ...
        <q-card style="width: 700px; max-width: 80vw;">
          ...
          <q-card-section>
            <q-form @submit="addMachine" @reset="reset" class="q-gutter-md">
              <div class="row">
                <div class="col">
                  <q-input class="q-mr-sm"
                    ...
                    full-width
                    lazy-rules
                    :rules="[val => (val && val.length > 0) || 'Enter Vehicle Name']"
                  />
                </div>
                <div class="col">
                  <q-input class="q-mr-sm"
                    ...
                    full-width
                    lazy-rules
                    :rules="[val => (val && val.length > 0) || 'Enter Owner Name']"
                  />
                </div>
                <div class="col">
                  <q-select
              ...
              <div class="row">
                <div class="col">
                  <q-input class="q-mr-sm"
                    ...
                    full-width
                    lazy-rules
                    :rules="[val => (val && val.length > 0) || 'Enter Registration Number']"
                  />
                </div>
                <div class="col">
                  <q-input dense outlined v-model="machine.registration_date" :rules="['DD-MM-YYYY']"  label="Registration Date" :placeholder="'dd-mm-yyyy'">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
                        <q-date v-model="machine.registration_date" mask="DD-MM-YYYY">
              ...
              <div class="row">
                <div class="col">
                  <q-input class="q-mr-sm"
                    ...
                    full-width
                    lazy-rules
                    :rules="[val => (val && val.length > 0) || 'Enter Chasis Number']"
                  />
                </div>
                <div class="col">
                  <q-input class="q-mr-sm"
                    ...
                    full-width
                    lazy-rules
                    :rules="[val => (val && val.length > 0) || 'Enter Engine Number']"
                  />
                </div>
              </div>
              ...
              <div class="row">
                 <div class="col">
                  ...
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
                        <q-date v-model="machine.insurance_valid_up_to" mask="DD-MM-YYYY">
                          <div class="row items-center justify-end">
                            <q-btn class="text-capitalize" v-close-popup label="Close" color="primary" flat />
                          </div>
                        </q-date>
                ...
                <div class="col">
                  <q-input class="q-mr-sm" dense outlined v-model="machine.tax_valid_up_to" :rules="['DD-MM-YYYY']"  label="Tax Validiy" :placeholder="'dd-mm-yyyy'">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
                        <q-date v-model="machine.tax_valid_up_to" mask="DD-MM-YYYY">
                          <div class="row items-center justify-end">
                            <q-btn class="text-capitalize" v-close-popup label="Close" color="primary" flat />
                          </div>
                        </q-date>
                ...
                <div class="col">
                  <q-input dense outlined v-model="machine.permit_valid_up_to" :rules="['DD-MM-YYYY']"  label="Permit Validiy" :placeholder="'dd-mm-yyyy'">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
                        <q-date v-model="machine.permit_valid_up_to" mask="DD-MM-YYYY">
                          <div class="row items-center justify-end">
                            <q-btn class="text-capitalize" v-close-popup label="Close" color="primary" flat />
                          </div>
                        </q-date>
              ...
              <div class="row">
                 <div class="col">
                  <q-input class="q-mr-sm" dense outlined v-model="machine.pollution_valid_up_to" :rules="['DD-MM-YYYY']"  label="Pollution Validiy" :placeholder="'dd-mm-yyyy'">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
                        <q-date v-model="machine.pollution_valid_up_to" mask="DD-MM-YYYY">
                          <div class="row items-center justify-end">
                            <q-btn class="text-capitalize" v-close-popup label="Close" color="primary" flat />
                          </div>
                        </q-date>
                ...
                <div class="col">
                  <q-input dense outlined v-model="machine.fitness_valid_up_to" :rules="['DD-MM-YYYY']"  label="Fitness Validiy" :placeholder="'dd-mm-yyyy'">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy ref="qDateProxy" cover transition-show="scale" transition-hide="scale">
                        <q-date v-model="machine.fitness_valid_up_to" mask="DD-MM-YYYY">
                          <div class="row items-center justify-end">
                            <q-btn class="text-capitalize" v-close-popup label="Close" color="primary" flat />
                          </div>
                        </q-date>
  ...
  setup () {
    return {
      ...
      columns: [
        ...
        {name: "machine_type",  align: "left", label: "Category", field: "machine_type", sortable: true},
        ...
        {name: "pollution_valid_up_to",  align: "left", label: "Pollution Up To", field: "pollution_valid_up_to", sortable: true},
        {name: "fitness_valid_up_to",  align: "left", label: "Fitness Up To", field: "fitness_valid_up_to", sortable: true},
