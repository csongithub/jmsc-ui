...
export default {
  addAccount(account) {
    return api
      .post("/v1/bankaccount/addBankAccount/", account)
      .then((response) => {
  ...
  getAccounts(clientId) {
    ...
    return api
      .get("/v1/bankaccount/getAllAccounts?" + params)
      .then((response) => {
        let records = response.data;
        return records;
      })
  ...
  getActiveAccounts(clientId) {
    ...
    return api
      .get("/v1/bankaccount/getActiveAccounts?" + params)
      .then((response) => {
        let records = response.data;
        return records;
      })
  ...
  accountById(clientId, accountId) {
    return api
      .get("/v1/bankaccount/account_by_id/" + clientId + "/" + accountId)
      .then((response) => {
